...
namespace Diff
{
    ...
    /**-
     * Commented out code removed. Refer to original file http://code.google.com/p/google-diff-match-patch/ line 48
     */
    ...
    public class DiffMatchPatch
    {
        ...
        public List<Diff> DiffLineMode(string text1, string text2) {
          ...
          var diffs = DiffMain(lineText1.ToString(), lineText2.ToString(), false);

          DiffCharsToLines(diffs, (List<string>)lineArray);
          return diffs;
        }

        public List<Diff> DiffWordMode(string text1, string text2) {
        ...
        protected Object[] DiffLinesToWords(string text1, string text2)
        {
            List<string> lineArray = new List<string>();
            Dictionary<string, int> lineHash = new Dictionary<string, int>();
            // e.g. linearray[4] == "Hello\n"
            ...
            string chars1 = DiffLinesToWordsMunge(text1, lineArray, lineHash);
            string chars2 = DiffLinesToWordsMunge(text2, lineArray, lineHash);
            return new Object[] { chars1, chars2, lineArray };
        }
        ...
        private string DiffLinesToWordsMunge(string text, List<string> lineArray, Dictionary<string, int> lineHash)
        {
            int lineStart = 0;
            int lineEnd = -1;
            string line;
            ...
            while (lineEnd < text.Length - 1)
            {
                lineEnd = Regex.Match(text.Substring(lineStart), @"\s+").Index + lineStart;
                if (lineEnd == -1)
                {
                    lineEnd = text.Length - 1;
                }
        ...
        protected string[] DiffHalfMatch(string text1, string text2)
        {
            ...
            {
                return hm;
                //commented out code removed. Refer to original file. http://code.google.com/p/google-diff-match-patch/ line 799
            }
            else
            {
            ...
            foreach (string token in tokens)
            {
                ...
                switch (token[0])
                {
                    case '+':
                        ...
                        //Commented out code removed refer to original file. http://code.google.com/p/google-diff-match-patch/ line 1485
        ...
        {
            // Commented out code removed. Refer to original file http://code.google.com/p/google-diff-match-patch/ line 1578
