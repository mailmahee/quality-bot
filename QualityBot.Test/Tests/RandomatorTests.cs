...
namespace QualityBot.Test.Tests
{
    ...
    class RandomatorTests : BaseTest
    {
        ...
        public void VerifyReplaceFirstOccurence()
        {
            ...
            var result = Randomator.ReplaceFirstOccurrence(testItem, oldItem, newItem);
            Assert.IsTrue(result.Contains(newItem));

            result = Randomator.ReplaceFirstOccurrence(result, " ", "-");
            Assert.IsTrue(result.Contains(newItem)); 
        }
        ...
        {
            var result = Randomator.ReplaceFirstOccurrence("a", null, "");
            Console.WriteLine(result);
        ...
        {
            var result = Randomator.ReplaceFirstOccurrence("a", "b", null);
            Console.WriteLine(result);
            Assert.IsTrue(result == "a");
        }
    }
